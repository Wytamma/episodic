...
Here we can see marginal likelihood estimates (MLE) for each clock model, with the FLC shared-stem model having the highest marginal likelihood and strong support (log Bayes factor 2.8) over the strict and relaxed clock models.

<img src="/images/mle.svg" alt="Relaxed clock MCC tree" style="width:100%;" />