...
# the mle is on a line like this:
# log marginal likelihood (using stepping stone sampling)
# from pathLikelihood.delta = -143654.15496497147
...
fig, ax = plt.subplots(figsize=(10, max(3, df["Clock"].nunique() * 1.5)))
